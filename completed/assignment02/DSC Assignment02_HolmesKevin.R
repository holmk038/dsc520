...
setwd("/Users/kevin/Documents/GitHub/dsc520/data")
...
person_df2 <- read.csv("tidydomicon/person.csv", stringsAsFactors = FALSE)
str(person_df2)
...
excel_sheets("G04ReultsDetail2004-11-02.xls")
...
voter_turnout_df1 <- read_excel("G04ResultsDetails2004-11.02.xls",sheet = "Voter Turnout",skip = 1)
...
db <- dbConnect(RSQLite;;SQLite(),"tidynomicon/eample.db")
